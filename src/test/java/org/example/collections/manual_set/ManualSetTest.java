...
public class ManualSetTest {
    ...
    void testManualSetWithDefaultConstructor() {
        ...
        assertEquals(DEFAULT_CAPACITY, manualSet.getCapacity(), String.format("ManualSet capacity should be %d.", DEFAULT_CAPACITY));
        assertEquals(0, manualSet.getSize(), String.format("ManualSet size should be %d", 0));
        int[] defaultArray = new int[DEFAULT_CAPACITY];
        assertArrayEquals(defaultArray, manualSet.getData(), String.format("ManualSet should contain %d zeros.", DEFAULT_CAPACITY));
    }
    ...
    void testManualSetWithCapacityGreaterThanDefault() {
        ...
        assertEquals(DEFAULT_CAPACITY * 2, manualSet.getCapacity(), String.format("ManualSet capacity should be %d.", DEFAULT_CAPACITY * 2));
        assertEquals(0, manualSet.getSize(), String.format("ManualSet size should be %d.", 0));
        int[] defaultArray = new int[DEFAULT_CAPACITY * 2];
        assertArrayEquals(defaultArray, manualSet.getData(), String.format("ManualSet should contain %d zeros.", DEFAULT_CAPACITY * 2));
    }
    ...
    void testManualSetWithSetCapacityLessThanDefault() {
        ...
        assertEquals(DEFAULT_CAPACITY, manualSet.getCapacity(), String.format("ManualSet capacity should be %d.", DEFAULT_CAPACITY));
        assertEquals(setWithCapacityLessThanDefault.length, manualSet.getSize(), String.format("ManualSet size should be %d.", setWithCapacityLessThanDefault.length));
        assertArrayEquals(setWithCapacityLessThanDefault, manualSet.toArray(), "ManualSet should be equal to setWithCapacityLessThanDefault.");
    }
    ...
    void testManualSetWithSetCapacityGreaterThanDefault() {
        ...
        assertEquals(DEFAULT_CAPACITY * 2, manualSet.getCapacity(), String.format("ManualSet capacity should be %d.", DEFAULT_CAPACITY * 2));
        assertEquals(setWithCapacityGreaterThanDefault.length, manualSet.getSize(), String.format("ManualSet size should be %d.", setWithCapacityGreaterThanDefault.length));
        assertArrayEquals(setWithCapacityGreaterThanDefault, manualSet.toArray(), "ManualSet should be equal to setWithCapacityGreaterThanDefault.");
    }
    ...
    void testManualSetWithArrayWithDuplicates() {
        ...
        assertEquals(arrayWithoutDuplicates.length, manualSet.getSize(), String.format("ManualSet size should be %d.", arrayWithoutDuplicates.length));
        assertArrayEquals(arrayWithoutDuplicates, manualSet.toArray(), "ManualSet should be equal to arrayWithoutDuplicates.");
    }
}
